...
<body>
    ...
    <div style="width: 900px;" class="container max-w-full mx-auto pt-5">
        ...
        <form action="/posts/{{ $post->id }}" method="POST">
            ...
            <a href="/posts"
                class="bg-gray-500 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-1g rounded hover:shadow">
                Cancel
            </a>
            ...
            <form action="/posts/ {{ $post->id }} ">
                ...
                <button href="/posts"
                    class="bg-red-500 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-1g rounded hover:shadow">
                    Delete
                </button>
            </form>
        </form>
